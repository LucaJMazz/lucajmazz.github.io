        ...
        <>
            <div className='landing-container'>
                ...
                <div className='title-container flex flex-col justify-center items-center'>
                    <h1>Luca Mazzotta</h1>
                    <h2 className='text-3xl flex flex-col justify-center text-center items-center'>Computer Science student at York Univserity
                        <motion.hr
                            className='h-1'
                            initial={{ width: 0 }}
                    ...
                    <motion.h2 className='text-2xl text-center'
                        initial={{ scale: 0 }}
                        whileInView={{ scale: 1 }}
                        viewport={{ once: true, amount: 0.5 }}
                    ...
                    <div className='linkContainer flex flex-row mt-10'>
                        <a href="/Luca Mazzotta, Computer Science - Resume.pdf" download>
                            <motion.h2
                            initial={{ scale: 0 }}
                            whileInView={{ scale: 1 }}
                            viewport={{ once: true, amount: 0.5 }}
                            transition={{ type: "spring", stiffness: 260, damping: 16, delay: 1.2 }}
                            className='underline text-lg m-2.5 cursor-pointer link'> 
                                <IoDocumentTextOutline className='icon'/> Resume.pdf 
                            </motion.h2>
                        </a>
                        <a href='https://www.linkedin.com/in/luca-j-mazzotta/' target="_blank">
                            <motion.h2
                                initial={{ scale: 0 }}
                                whileInView={{ scale: 1 }}
                                viewport={{ once: true, amount: 0.5 }}
                        ...
                        <a href='https://github.com/LucaJMazz' target="_blank">
                            <motion.h2
                                initial={{ scale: 0 }}
                                whileInView={{ scale: 1 }}
                                viewport={{ once: true, amount: 0.5 }}
